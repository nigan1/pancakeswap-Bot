...
tokenValue= web3.toWei(config.inversion_bnb, 'ether')

spend = web3.toChecksumAddress(config.bnb)   # contrato wbnb con que tenga liquidez el token que vas a comprar
